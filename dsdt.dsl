 ...
 *     Signature        "DSDT"
 *     Length           0x0000D66E (54894)
 *     Revision         0x02
 *     Checksum         0xBB
 *     OEM ID           "MSI_NB"
 *     OEM Table ID     "MEGABOOK"
 *     OEM Revision     0x69B6EFA2 (17244169)
 *     Compiler ID      "INTL"
 *     Compiler Version 0x20200717 (538969879)
 */
DefinitionBlock ("", "DSDT", 2, "MSI_NB", "MEGABOOK", 0x69B6EFA2)
{
...
//                }
    ...
    Method (PTEC, 1, NotSerialized)
    {
        ...
        If ((CondRefOf (\_PR.P00A._PSS) && CondRefOf (\_PR.P00A.PPCV)))
        {
            ...
            {
                \_PR.P00A.PPCV = (SizeOf (\_PR.P00A._PSS) - One)
            }
            Else
            {
    ...
    Scope (_SB.PCI0.SBRG)
    {
        ...
        Device (EC)
        {
            ...
            OperationRegion (ECRM, SystemMemory, 0xFE0B0400, 0x1000)
            ...
            Method (_QB7, 0, NotSerialized)  // _Qxx: EC Query, xx=0x00-0xFF
            {
                ...
                If ((OSVR >= 0x02))
                {
                    ...
                    {
                        DBG8 = 0x30
                        Notify (\_SB.PCI0.GPP0.PEGP.EDP1, 0x87) // Device-Specific
                    }
                    Else
                    {
                        DBG8 = 0x31
            ...
            Method (_QB8, 0, NotSerialized)  // _Qxx: EC Query, xx=0x00-0xFF
            {
                ...
                If ((OSVR >= 0x02))
                {
                    ...
                    {
                        DBG8 = 0x20
                        Notify (\_SB.PCI0.GPP0.PEGP.EDP1, 0x86) // Device-Specific
                    }
                    Else
                    {
                        DBG8 = 0x21
            ...
            Method (_QC2, 0, Serialized)  // _Qxx: EC Query, xx=0x00-0xFF
            {
                ...
                If ((GPUI == 0x48))
                {
                    Switch (SYSM)
                    {
                        Case (0xC4)
                        {
                            \_SB.NPCF.ATPP = 0x0168
                            \_SB.NPCF.AMAT = 0x78
                            \_SB.NPCF.AMIT = 0xFFB0
                            Notify (NPCF, 0xC0) // Hardware-Specific
                            \_SB.PCI0.GPP0.PEGP.NLIM = One
                            \_SB.PCI0.GPP0.PEGP.STGU = 0x57
    ...
    Scope (_SB.PCI0.SBRG.EC)
    {
        ...
        Method (_Q9A, 0, NotSerialized)  // _Qxx: EC Query, xx=0x00-0xFF
        {
            DBG8 = 0x9A
            SCIC = 0x9A
            FromBCD (\_SB.PCI0.SBRG.RTC0.YEAR, YEAT) /* \_SB_.PCI0.SBRG.EC__.YEAT */
            FromBCD (\_SB.PCI0.SBRG.RTC0.MON, MONT) /* \_SB_.PCI0.SBRG.EC__.MONT */
            FromBCD (\_SB.PCI0.SBRG.RTC0.DAY, DAYT) /* \_SB_.PCI0.SBRG.EC__.DAYT */
        }
    }
}
